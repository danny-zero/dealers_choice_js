...
INSERT INTO details (hero_id, powers, bio, img) VALUES ((SELECT id FROM heroes WHERE codename='Batman'), 'He''s Batman, just don''t, trust me, you''ll regret it', 'Batman (real name Bruce Wayne), from Gotham City and a founding member of the Justice League. Witnessing the murder of his parents as a child leads him to train himself to physical and intellectual perfection and don a bat-themed costume in order to fight crime.', 'https://i.pinimg.com/originals/6f/ba/b8/6fbab84819d016a4e1c331f202af9b30.jpg');
...
', 'https://64.media.tumblr.com/tumblr_m5s4jiVxk91qfxwtoo4_1280.jpg');
